    ...
    <main>
      ...
      <section className="home-hero">
        <div className="hero-main">
          <p className="kicker">M.S. Computer Science · AI & systems</p>
          <h1>Building intelligent software—and understanding every layer beneath it.</h1>
          <p className="hero-summary">I’m Aakkash, an M.S. Computer Science student at UC San Diego. I build AI products, low-level systems, and tools that make complicated technology easier to trust, use, and learn from.</p>
