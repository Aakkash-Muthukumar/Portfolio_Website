    ...
    <main>
      ...
      <section className="home-hero">
        <div className="hero-main">
          ...
          <h1>Building intelligent software—and understanding every layer beneath it.</h1>
          <p className="hero-summary">I’m Aakkash, an incoming M.S. Computer Science student at UC San Diego. I build AI products, low-level systems, and tools that make complicated technology easier to trust, use, and learn from.</p>
      ...
      <section className="home-about">
        ...
        <div><p className="section-label">03 / A little more personal</p><h2>My favorite question is usually: what’s happening underneath?</h2><p>That question has taken me from Grad-CAM attention maps to local language models, a hand-written bootloader, and the Arch Linux environment I use every day.</p><p>I bring the same instinct to teaching: help someone reason through the failure, not memorize the fix. Photography gives that curiosity a slower, more observant outlet away from the terminal.</p><a href="/about">More about me <span>→</span></a></div>
      </section>
      <SiteFooter />
    </main>
  );
